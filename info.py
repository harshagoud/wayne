...
BOT_TOKEN = environ.get('BOT_TOKEN', '6137983745:AAFQNy-gAl_szhHYN0gFR2bg71SfxMX4uts')
...
DATABASE_NAME = environ.get('DATABASE_NAME', "wayneverse")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'wayne_files')
